...
//void TeaEncryptor::fir(uint32_t *v, uint32_t *k, int size, int size_C) {
//    for (int i = 0; i < size; i++) {
//        uint32_t temp = 0;
//        int N_start_point = i - (size_C / 2);
//        for (int j = 0; j < size_C; j++) {
//            if (N_start_point + j >= 0 && N_start_point + j < size) {
//                temp += v[N_start_point + j] * k[j];
//            }
//        }
//        v[i] = temp;
//    }
...
//
//
//void fir(uint *v, uint *k, int size, int size_C) {
//    for (int i = 0; i < size; i++) {
//        uint temp = 0;
//        int N_start_point = i - (size_C / 2);
//        for (int j = 0; j < size_C; j++) {
...
///* BASIC GPU KERNEL */
///********************/
//__global__ void fir(uint *v, uint *k, int size, int size_C) {
//    int i = (blockIdx.x * blockDim.x) + threadIdx.x;
//    uint temp = 0;
//    int N_start_point = i - (size_C / 2);
//    for (int j = 0; j < size_C; j++) if (N_start_point + j >= 0 && N_start_point + j < size) {
//            temp += v[N_start_point+ j] * k[j];
//        }
//    v[i] = temp;
//}
