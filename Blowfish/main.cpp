...
int blowfish_encrypt(const unsigned char *pt, unsigned char *ct, const symmetric_key_blowfish *skey);
...
int blowfish_setup(const unsigned char *key, int keylen, int num_rounds, symmetric_key_blowfish *skey) {
   ulong32 x, y, z, a;
   unsigned char b[8];
...
int blowfish_decrypt(const unsigned char *ct, unsigned char *pt, const symmetric_key_blowfish *skey) {
   ulong32 L, R;
   int r;
...
void blowfish_done(symmetric_key_blowfish *skey){
    (void)(skey);
}
