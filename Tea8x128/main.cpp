...
public:
    TeaEncryptor();
    void encrypt16(uint8_t *v0, uint8_t *v1, const uint32_t *k, int size);
    void decrypt16(uint8_t *v0, uint8_t *v1, const uint32_t *k, int size);
...
void TeaEncryptor::encrypt16(uint8_t *v0, uint8_t *v1, const uint32_t *k, int size) {
    for (int i = 0; i < size; i ++) {
...
void TeaEncryptor::decrypt16(uint8_t *v0, uint8_t *v1, const uint32_t *k, int size) {
    for (int i = 0; i < size; i ++) {
